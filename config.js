// =============================================================================
// config.js — 7Bit Circuit Training PWA
// Central configuration: modes, energy, XP curve, muscle groups, copy
// =============================================================================
...
const CONFIG = {
  ...
  // XP-to-Level curve — 7 levels, front-loaded
  levels: [
  ...
  muscleGroups: ['chest','back','shoulders','triceps','biceps','core','obliques','legs','glutes','forearms','grip','fingers'],
