...
export const DATA_CAVE: Circuit[] = [
  {
    ...
    exercises: [
      ...
      { ...WARMUP_FINGERS, sets: 4 },
      {
        ...
        protocolId: 'max-hang',
        variations: [
          { minLevel: 1, name: 'Half-Crimp 20mm — Assisted', load: 'Pulley assist to a hard 10s' },
          { minLevel: 3, name: 'Half-Crimp 20mm — Bodyweight' },
          { minLevel: 4, name: 'Half-Crimp 20mm — Weighted' },
          { minLevel: 6, name: 'Half-Crimp 20mm — Heavy', load: '130%+ bodyweight' },
        ],
        form: {
